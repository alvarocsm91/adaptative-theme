...
* adaptative-theme
  ...
  This file contain package function explanation, all use cases, function
  description and examples. For more information contact me.
...
* Requirements
  ...
  installed in the function execution, this package require /Emacs 25.1/ or
  later varsion. This functions has been tested with my /init.el/ configuration
  and /Emacs 28.0.50/.
...
** adaptative-theme-location
   ...
   /adaptative-theme/ because access to internet to get data time.
...
** adaptative-theme
   ...
   As have optional values is important to define default values if this
